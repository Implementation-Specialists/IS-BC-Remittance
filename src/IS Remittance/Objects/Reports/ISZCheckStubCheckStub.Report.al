...
report 66051 "ISZ Check (Stub/Check/Stub)"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Objects/Reports/Layouts/StubCheckStub.rdlc';
    ...
    trigger OnPreReport()
    begin
        GenJournalTemplate.Get(VoidGenJnlLine.GetFilter("Journal Template Name"));
